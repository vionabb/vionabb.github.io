<main class="mw-prose p-4 prose mx-auto">
    <h1 class="text-2xl mb-0">Hi! I'm Julien <small class="text-base-300">He/They</small></h1>
    ...
    <div>
        <!-- Using Font Awesome 6 Brands Icons: https://icon-sets.iconify.design/fa6-brands/ -->
        <a href="https://www.linkedin.com/in/julienbblanchet/" class="btn btn-ghost text-xl btn-sm" aria-label="LinkedIn">
            <span class="icon-[fa6-brands--linkedin]"></span>
        </a>
        <a href="https://github.com/j55blanchet" class="btn btn-ghost text-xl btn-sm" aria-label="GitHub">
