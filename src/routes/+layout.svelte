...
const themeOptions = ['vionalight', 'vionadark'] as const;
const lightTheme = 'vionalight';
const darkTheme = 'vionadark';
...
onMount(() => {
    theme = localStorage.getItem('theme') as null | 'vionalight' | 'vionadark';
});
...
function setTheme(event: Event) {
    ...
    theme = target.value as null | 'vionalight' | 'vionadark';
}
...
<div class="drawer md:drawer-open">
    ...
    <div class="drawer-content">
        <nav class="navbar bg-base-100">
            ...
            <div class="navbar-end space-x-0">
                ...
                <a href="https://github.com/vionabb" class="btn btn-ghost text-lg" aria-label="GitHub" title="GitHub">
                ...
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button" id="toggleTheme" class="btn btn-ghost" aria-label="Select Theme">
                        <label class="swap swap-rotate" for="toggleTheme" class:swap-active={effectiveTheme === "vionalight"}>
                            <div class="swap-on">
                    ...
                    <ul class="dropdown-content rounded-box shadow bg-base-200 p-2">
                        ...
                        <li><input type="radio" name="theme-dropdown" class="theme-controller btn btn-sm btn-block btn-ghost justify-start" aria-label="Light" value="vionalight" bind:group={theme}/></li>
                        <li><input type="radio" name="theme-dropdown" class="theme-controller btn btn-sm btn-block btn-ghost justify-start" aria-label="Dark" value="vionadark" bind:group={theme}/></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="drawer-side lg:w-80">
        ...
        <div class="bg-base-200 min-h-screen">            
            <ul class="menu">
                <li class="menu-title text-xl font-slabserif font-light text-base-content"><span><strong class="font-bold inline">Viona</strong> Blanchet</span></li>
                ...
                <!-- <ul class="menu menu-horizontal p-0">
                    ...
                    <li><a href="https://github.com/vionabb" class="btn btn-ghost text-xl btn-sm" aria-label="GitHub" title="GitHub">
                        <span class="icon-[fa6-brands--github]"></span>
                    </a></li>
                </ul> -->
            </ul>
